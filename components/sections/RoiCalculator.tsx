        ...
        <div className="flex flex-col items-center justify-center w-full max-w-4xl mx-auto space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center w-full gap-4 sm:gap-6">
            ...
            <motion.div
              ...
              className="flex-1 w-full flex flex-col items-center text-center p-5 sm:p-8 md:p-10 rounded-xl sm:rounded-2xl border border-white/5 bg-white/[0.015] backdrop-blur-sm lg:hover:bg-white/[0.03] transition-colors duration-300 transform-gpu h-full"
            >
              <div className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 mb-4 sm:mb-6 flex items-center justify-center rounded-lg sm:rounded-xl border border-brand-bone/10 bg-brand-bone/5 text-brand-bone">
              ...
              <h3 className="font-sans text-lg sm:text-xl text-brand-bone/90 font-light leading-snug">
                Si vendés equipos de <br className="hidden md:block" />
                <strong className="font-accent italic text-brand-terracotta font-bold text-2xl sm:text-3xl tracking-wide block mt-1.5 sm:mt-2">
                  $1.500.000
                </strong>
              </h3>
            </motion.div>
            ...
            <motion.div
              ...
              className="flex-1 w-full flex flex-col items-center text-center p-5 sm:p-8 md:p-10 rounded-xl sm:rounded-2xl border border-white/5 bg-white/[0.015] backdrop-blur-sm lg:hover:bg-white/[0.03] transition-colors duration-300 transform-gpu h-full"
            >
              <div className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 mb-4 sm:mb-6 flex items-center justify-center rounded-lg sm:rounded-xl border border-brand-terracotta/20 bg-brand-terracotta/10 text-brand-terracotta">
                <RefreshCcwDot className="w-6 h-6 sm:w-8 sm:h-8 opacity-90" />
              </div>
              ...
              <h3 className="font-sans text-lg sm:text-xl text-brand-bone/90 font-light leading-snug">
                Y <strong className="font-brand font-bold tracking-tighter text-brand-terracotta">rulo<span className="text-brand-bone">.</span></strong> te reactiva <br className="hidden md:block" />
                <strong className="font-accent italic text-brand-terracotta font-bold text-2xl sm:text-3xl tracking-wide block mt-1.5 sm:mt-2">
                  solo 2 clientes
                </strong>
              </h3>
          ...
          >
            ...
            <div className="flex-shrink-0 w-14 h-14 sm:w-20 sm:h-20 mb-4 sm:mb-6 flex items-center justify-center rounded-lg sm:rounded-xl border border-[#52B788]/30 bg-[#52B788]/10 text-[#52B788] shadow-[0_0_30px_rgba(82,183,136,0.1)] transition-transform duration-500 lg:group-hover:scale-110">
              <CircleDollarSign className="w-7 h-7 sm:w-10 sm:h-10" />
            </div>

            <p className="font-mono text-xs sm:text-sm text-[#52B788] font-semibold uppercase tracking-[0.15em] sm:tracking-[0.2em] mb-1.5 sm:mb-2">Retorno Generado</p>
            <h3 className="font-accent italic text-white font-bold text-3xl sm:text-5xl md:text-6xl lg:text-[5.5rem] tracking-tight leading-none mb-3 sm:mb-4">
              $3.000.000 <span className="text-xl sm:text-3xl text-brand-bone/60 ml-0.5 sm:ml-1 tracking-normal">extra</span>
            </h3>
        ...
        >
          <div className="max-w-2xl text-center px-5 sm:px-8 py-4 sm:py-5 rounded-xl sm:rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-md shadow-lg">
            <p className="font-sans text-brand-bone text-sm sm:text-base md:text-lg font-medium leading-relaxed">
              Nuestro costo sigue siendo el mismo abono fijo.<br className="hidden sm:block" />
              <span className="text-white font-bold border-b-2 border-[#52B788] pb-0.5 sm:ml-2 mt-2 sm:mt-0 inline-block">
                El retorno de inversión es automático.
              </span>
            </p>
          </div>
        </motion.div>
